...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''EnableResilientVMCreate'' and ''EnableResilientVMDelete'' parameters to ''Update-AzVmss'' and ''New-AzVmssConfig'' cmdlets for enhanced VM resilience options.'
